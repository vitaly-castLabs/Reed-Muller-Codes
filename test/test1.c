...
int main(void) {
    ...
    loop("111111111111111111111111111111111",2,4);      // RM(2,4)->(16,11,4) - input has to be multiple of 11
    ...
    loop("11111111111111111111111111111111111",2,3);    // RM(2,3)->(8,7,2) - input has to be multiple of 7
